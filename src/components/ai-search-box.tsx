      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row-reverse items-center justify-between gap-6">
        ...
        <div className="flex flex-row-reverse items-center gap-6 w-full md:w-auto overflow-x-auto no-scrollbar">
          {SPECIAL_CATEGORIES.map((cat, i) => (
            ...
            >
              <div className="w-16 h-16 rounded-xl bg-black border border-secondary/30 flex items-center justify-center text-secondary group-hover:bg-secondary group-hover:text-black transition-all shadow-xl">
                {cat.icon}
              </div>
              <span className="text-sm font-black text-secondary group-hover:text-white transition-colors text-center whitespace-nowrap uppercase tracking-tighter">
                {cat.name}
              </span>
            </Link>
          ))}
        ...
        <div className="w-full max-w-sm relative">
          <div className="absolute -top-5 left-0 flex items-center gap-2">
            <span className="text-[9px] font-black text-secondary uppercase tracking-widest bg-black px-2 py-0.5 rounded border border-secondary/20 flex items-center gap-1.5">
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className="pl-12 h-10 bg-white border-2 border-secondary/30 text-primary text-lg font-black placeholder:text-zinc-400 focus:ring-secondary focus:border-secondary transition-all text-right rounded-xl shadow-lg"
              dir="rtl"
              value={query}

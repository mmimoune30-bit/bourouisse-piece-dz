...
import { Package, ShoppingBag, Settings, Plus, TrendingUp, MessageSquare, ArrowLeft } from "lucide-react";
          ...
          <div className="text-right" dir="rtl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
               <Card className="border-none shadow-sm overflow-hidden group">
                  <CardContent className="p-6 flex items-center justify-between">
                     <div className="text-right">
                        <p className="text-xs font-black text-muted-foreground uppercase mb-1">مشاهدات الإعلانات</p>
                        <h3 className="text-3xl font-black text-primary">1,284</h3>
                        <p className="text-[10px] text-green-600 font-bold mt-1">+12% منذ أمس</p>
                     </div>
               ...
               <Card className="border-none shadow-sm overflow-hidden group">
                  <CardContent className="p-6 flex items-center justify-between">
                     <div className="text-right">
                        <p className="text-xs font-black text-muted-foreground uppercase mb-1">الطلبات الجديدة</p>
                        <h3 className="text-3xl font-black text-secondary">5</h3>
                        <p className="text-[10px] text-zinc-400 font-bold mt-1">تتطلب الرد سريعاً</p>
                     </div>
               ...
               <Card className="border-none shadow-sm overflow-hidden group">
                  <CardContent className="p-6 flex items-center justify-between">
                     <div className="text-right">
                        <p className="text-xs font-black text-muted-foreground uppercase mb-1">الرسائل</p>
                        <h3 className="text-3xl font-black text-green-600">3</h3>
                        <p className="text-[10px] text-zinc-400 font-bold mt-1">استفسارات الزبائن</p>
                     </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {menuItems.map((item, idx) => (
                 <Link key={idx} href={item.href} className="block group">
                   <div className="bg-white p-10 rounded-[40px] shadow-sm border-2 border-transparent group-hover:border-primary/10 group-hover:shadow-xl transition-all flex flex-col items-center justify-center text-center relative overflow-hidden h-full">
